        ...
        %logic indexing
          function [current_density,densityX,densityY] = iterate(interval,traceX,traceY, Vx, Vy, dt, MatrixAx, MatrixAy, box1, box2)
              ...
              for i=1:interval
                  ...
                  [traceXNew(i,:), traceXNew(i+1,:), Vx ]= traceGen_p3.stepNext(0,traceXNew(i,:),Vx, dt,1);
                  ...
                  [traceXNew(i,:), traceXNew(i+1,:), Vx ]= traceGen_p3.stepNext(checkX,traceXNew(i,:),Vx, dt,0,0,Ax*(50/200e-9/2));
