        ...
        %logic indexing
          function [traceXNew,traceYNew] = iterate(interval,traceX,traceY, Vx, Vy, dt, MatrixAx, MatrixAy)
              ...
              for i=1:interval
                  ...
                  [Vx,Vy,LastCollision,NextCollision,FreePathHist(i,:)]=traceGen_p1.scatter(Vx,Vy,T,LastCollision,NextCollision,FreePathHist(i,:));
                  ...
                  [traceXNew(i,:), traceXNew(i+1,:), Vx ]= traceGen_p1.stepNext(checkX,traceXNew(i,:),Vx, dt,1,0,Ax*(50/200e-9/2));
                  [traceYNew(i,:),traceYNew(i+1,:), Vy ]= traceGen_p1.stepNext(checkY,traceYNew(i,:),Vy, dt,0,0,Ay*(40/100e-9/2));
                  ...
                  traceGen_p1.colormapMatrix(200e-9, 20, 100e-9, 10, traceXNew(i,:), traceYNew(i,:),Vx,Vy);
          ...
          function [Pos, nextPos, nextVel,Velocity2] = stepNext(checkArray, position, Velocity, dt, mode, Velocity2, Acceloration)
