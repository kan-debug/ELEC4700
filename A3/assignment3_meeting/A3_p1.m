...
[Ax,Ay] = fieldGen(1,1,1,20,20);
% stepsizeX,stepsizeY, sigma,size_box_x,size_box_y
...
[TraceParticlesX,TraceParticlesY] = traceGen_p1.iterate(i,TraceParticlesX(:,1:nParticlesPlot),TraceParticlesY(:,1:nParticlesPlot),VelocityParticleX(:,1:nParticlesPlot),VelocityParticleY(:,1:nParticlesPlot),dt, Ax, Ay);
